...
export const projects: Project[] = [
  {
    ...
    year: '2026',
    description: `Free tool for identifying AI-generated signatures in media files. Built
      as a public utility at the intersection of ML and media analysis, with a clean web
      interface for broad accessibility.`,
    tags: ['AI/ML', 'Svelte'],
  ...
  },
  {
    ...
    year: '2023-2025',
    description: `SaaS web platform connecting clients with specialists. Built end-to-end
      as an independent project, covering product design, frontend, backend,
      and infrastructure.`,
